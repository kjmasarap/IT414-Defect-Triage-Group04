## SC-01: Duplicate Payment Transaction on Double Submit

**Module / Feature:** Online Payment Processing

**Environment:** Production - Payment Module
...
## SC-02: Double Booking of Exclusive Time Slots

**Module / Feature:** Appointment / Booking System

**Environment:** Staging - Booking Module
...
## SC-03: Incorrect Test Case - Admin Dashboard Access Control

**Module / Feature:** Access Control / Admin Dashboard

**Environment:** Test Execution - Access Control Module
...
## SC-05: Spelling Error in Official University Name on Landing Page

**Module / Feature:** Official Content / UI - Landing Page

**Environment:** Production - Web Interface
...
## SC-06: Date Range Filter Includes Out-of-Range Transactions in Report

**Module / Feature:** Reports / Filtering
...
**Triage Notes:**
This is a confirmed defect in the date range filtering logic. The filter boundary conditions are incorrect—likely using an inclusive end date comparison (>= instead of <). This causes data accuracy issues in financial reports. The triage decision should determine whether the CSV export behavior is part of the same root cause or a separate issue requiring independent investigation.

---

## SC-07: Duplicate Defect Report - Multiple Open Issues for Same Failure

**Module / Feature:** Issue Tracking / Defect Management

**Environment:** QA Process - Issue Management
...
**Triage Notes:**
This is not a software defect in the application under test. This is a duplicate issue report resulting from independent testing efforts. The original issue (submitted earlier) should remain open with active investigation. The newly submitted duplicate should be closed with a comment linking to the original issue and acknowledging the duplicate report. This consolidates team effort on a single defect tracking entry.

---

## SC-08: Misleading Success Message - Record Not Actually Persisted (API 500 Error)

**Module / Feature:** Mobile App / API - Record Creation

**Environment:** Production - Mobile Application
